 ...
 */
 ...
 deleteNumFromArray(arrNum, deleteNum) {
   
    for(i = deleteNum; arrNum.includes(deleteNum)=== true; i++){
   
    let indexOfNum = arrNum.indexOf(deleteNum)
    let returnArray = arrNum.splice(indexOfNum, 1)
